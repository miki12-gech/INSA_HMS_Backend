...
/**
 * JPA Entity mapping the legacy `laboratorist` table.
 *
 * Column mapping from nhospital1 SQL dump (lines 714–725).
 * ALL 10 columns mapped 1:1 — DO NOT add, rename, or remove columns.
 *
 * x, y are legacy spare columns — preserved per agent.md §4.5.
 * ion_user_id → references users.id (the login account for this laboratorist).
 */
@Entity
...
public class Laboratorist {
    ...
    /** References users.id for the laboratorist's login account. */
